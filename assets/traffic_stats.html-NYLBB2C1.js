import{_ as t,r as e,o as p,c as o,a as n,b as s,d as l,e as i}from"./app-JqiKuxQm.js";const c={},u=n("h1",{id:"流量统计配置教程",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#流量统计配置教程","aria-hidden":"true"},"#"),s(" 流量统计配置教程")],-1),r={href:"https://guide.v2fly.org/advanced/traffic.html",target:"_blank",rel:"noopener noreferrer"},d=i(`<h2 id="查看流量信息" tabindex="-1"><a class="header-anchor" href="#查看流量信息" aria-hidden="true">#</a> 查看流量信息</h2><p>配置方法与 v2fly 一致。 查看流量信息是 xray 命令行的其中一个功能。配置内设置的 api dokodemo-door 端口，即为 <code>--server</code> 参数的端口。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>xray api statsquery <span class="token parameter variable">--server</span><span class="token operator">=</span><span class="token number">127.0</span>.0.1:10085 <span class="token comment">#查看所有流量</span>
...
xray <span class="token builtin class-name">help</span> api stats <span class="token comment">#stats 查询一个记录</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输出例子：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="流量信息的处理" tabindex="-1"><a class="header-anchor" href="#流量信息的处理" aria-hidden="true">#</a> 流量信息的处理</h2><p>把以下脚本保存到 <code>traffic.sh</code>，注意使用 <code>chmod 755 traffic.sh</code> 授予执行权限。注意调整修改 <code>_APISERVER</code> 一行的连接具体的端口参数。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<span class="token builtin class-name">echo</span> <span class="token string">&quot;-----------------------------&quot;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8);function v(k,b){const a=e("ExternalLinkIcon");return p(),o("div",null,[u,n("p",null,[s("请熟悉"),n("a",r,[s("流量统计 白话文教程"),l(a)]),s("，本文在其基础上适配了 Xray（1.5.9+）。")]),d])}const g=t(c,[["render",v],["__file","traffic_stats.html.vue"]]);export{g as default};
