...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,36),m={class:"custom-container tip"},p=e("p",{class:"custom-container-title"},"Tip",-1),x=e("p",null,[a("When "),e("code",null,"-config"),a(" is not specified, Xray will try to load "),e("code",null,"config.json"),a(" from the following paths:")],-1),g=e("li",null,"Working Directory",-1),h=e("code",null,"Xray.location.asset",-1);function b(f,y){const s=n("I18nTip"),t=n("RouterLink");return r(),l("div",null,[i(s),v,e("div",m,[p,x,e("ul",null,[g,e("li",null,[a("The path specified by "),h,a(" in the "),i(t,{to:"/en/config/features/env.html"},{default:c(()=>[a("environment variable")]),_:1}),a(".")])])])])}const w=d(u,[["render",b],["__file","command.html.vue"]]);export{w as default};
