...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 <code>[Interface]</code> 下添加如下命令：</p><div class="language-ini line-numbers-mode" data-ext="ini"><pre class="language-ini"><code><span class="token key attr-name">Table</span> <span class="token punctuation">=</span> <span class="token value attr-value">&lt;table&gt;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="custom-container tip"><p class="custom-container-title">提示</p><ul><li>此配置文件融合了 <code>fwmark</code> / <code>sendThrough</code> / <code>sockopt.interface</code>，表示</li><li>送入此设备 <code>%i</code> 的连接 / 送入此 <code>&lt;IPv4/6&gt;</code> 的连接 / <code>fwmark</code> 被标记为 <code>&lt;mark&gt;</code> 的连接</li><li>将会使用 wireguard 进行转发</li><li><code>%i</code> 是 wireguard 配置文件中的占位符，表示在启动时替换为这个设备的名称</li></ul></div><p>保存</p><p>可顺手安装</p><div class="custom-container warning"><p class="custom-container-title">注意</p><p>如果使用了 <code>[Interface]</code> 中的 <code>DNS</code> 字段，这个程序将会是必须的</p></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">apt</span> <span class="token function">install</span> openresolv
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_4、xray-core-配置文件修改" tabindex="-1"><a class="header-anchor" href="#_4、xray-core-配置文件修改" aria-hidden="true">#</a> 4、Xray-core 配置文件修改</h2><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>验证 IPv4/IPv6</p><blockquote><p>在代理上 运行 <code>curl ip-api.com -4/-6</code> / 浏览器访问ip-api.com</p></blockquote><h2 id="后记" tabindex="-1"><a class="header-anchor" href="#后记" aria-hidden="true">#</a> 后记</h2><p>本文本意是可以避免的多余的流量浪费，将路由和分流的功能交给 Xray 处理。避免了维护路由表的繁琐工作。顺便技术提升 UP。</p><h2 id="感谢" tabindex="-1"><a class="header-anchor" href="#感谢" aria-hidden="true">#</a> 感谢</h2>`,39),d={href:"https://github.com/XTLS/Xray-core",target:"_blank",rel:"noopener noreferrer"},k={href:"https://github.com/v2fly/v2ray-core",target:"_blank",rel:"noopener noreferrer"},v={href:"https://www.wireguard.com/",target:"_blank",rel:"noopener noreferrer"},m={href:"https://p3terx.com/",target:"_blank",rel:"noopener noreferrer"};function b(q,g){const a=o("ExternalLinkIcon");return p(),l("div",null,[r,s("p",null,[s("a",d,[n("XTLS/Xray-core"),t(a)]),n("; "),s("a",k,[n("v2fly/v2ray-core"),t(a)]),n("; "),s("a",v,[n("WireGuard"),t(a)]),n("; "),s("a",m,[n("@p3terx"),t(a)]),n("; @w; @Hiram; @Luminous; @Ln; @JackChou;")]),i("剩下几位大佬我实在找不到他们的地址或Github空间，请大家帮忙找吧")])}const y=e(u,[["render",b],["__file","redirect.html.vue"]]);export{y as default};
