...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>验证 IPv4/IPv6</p><blockquote><p>在代理上 运行 <code>curl ip-api.com -4/-6</code> / 浏览器访问ip-api.com</p></blockquote><h2 id="后记" tabindex="-1"><a class="header-anchor" href="#后记"><span>后记</span></a></h2><p>本文本意是可以避免的多余的流量浪费，将路由和分流的功能交给 Xray 处理。避免了维护路由表的繁琐工作。顺便技术提升 UP。</p><h2 id="感谢" tabindex="-1"><a class="header-anchor" href="#感谢"><span>感谢</span></a></h2>`,39),r={href:"https://github.com/XTLS/Xray-core",target:"_blank",rel:"noopener noreferrer"},d={href:"https://github.com/v2fly/v2ray-core",target:"_blank",rel:"noopener noreferrer"},k={href:"https://www.wireguard.com/",target:"_blank",rel:"noopener noreferrer"},v={href:"https://p3terx.com/",target:"_blank",rel:"noopener noreferrer"};function m(b,q){const a=p("ExternalLinkIcon");return o(),l("div",null,[u,s("p",null,[s("a",r,[n("XTLS/Xray-core"),t(a)]),n("; "),s("a",d,[n("v2fly/v2ray-core"),t(a)]),n("; "),s("a",k,[n("WireGuard"),t(a)]),n("; "),s("a",v,[n("@p3terx"),t(a)]),n("; @w; @Hiram; @Luminous; @Ln; @JackChou;")])])}const h=e(c,[["render",m],["__file","redirect.html.vue"]]);export{h as default};
