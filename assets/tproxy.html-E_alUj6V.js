...
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1);function w(P,F){const r=p("I18nTip"),o=p("ExternalLinkIcon"),t=p("Tab"),l=p("Tabs");return c(),u("div",null,[v,a(r),n("p",null,[s("本配置基于"),n("a",m,[s("TProxy 透明代理的新 V2Ray 白话文教程"),a(o)]),s("，加入了 Xray 的新特性，使用 VLESS + XTLS Vision 方案，并将旧教程中默认出站代理的分流方式改为默认出站直连，使用者请按照实际情况进行修改。")]),b,q,g,n("p",null,[s("需注意的是，目前很多透明代理教程都会将 Linux 系统的 IP 转发打开，但这样会导致 Splice 性能下降。详情请参考"),n("a",y,[s("大案牍术破案纪实第三篇--我们是如何破解 Splice 性能下降甚至低于 Direct 之谜的"),a(o)]),s("。")]),f,h,n("p",null,[s("为了更好的分流体验，请替换默认路由规则文件为 "),n("a",R,[s("Loyalsoldier/v2ray-rules-dat"),a(o)]),s("，否则 Xray-core 将无法加载本配置。")]),_,a(l,{title:"netfilter"},{default:e(()=>[a(t,{title:"nftables1"},{default:e(()=>[A,x]),_:1}),a(t,{title:"iptables1"},{default:e(()=>[E]),_:1})]),_:1}),T,S,a(l,{title:"netfilter2"},{default:e(()=>[a(t,{title:"nftables2"},{default:e(()=>[X,N,j]),_:1}),a(t,{title:"iptables2"},{default:e(()=>[Y,U,L,I]),_:1})]),_:1})])}const V=i(d,[["render",w],["__file","tproxy.html.vue"]]);export{V as default};
