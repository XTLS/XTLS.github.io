import{_ as d,r as n,o as l,c as r,a as i,b as e,w as c,d as a,e as o}from"./app-D3N2dWC1.js";const u={},v=o(`<h1 id="命令参数" tabindex="-1"><a class="header-anchor" href="#命令参数"><span>命令参数</span></a></h1><div class="custom-container tip"><p class="custom-container-title">提示</p><p>Xray 使用 Go 风格的命令及参数</p></div><h2 id="获取基本命令" tabindex="-1"><a class="header-anchor" href="#获取基本命令"><span>获取基本命令</span></a></h2><p>您可以运行 <code>xray help</code> 来获得所有 xray 最基础的用法, 以及可用的命令及说明。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>Xray is a platform for building proxies.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,40),m={class:"custom-container tip"},p=e("p",{class:"custom-container-title"},"提示",-1),x=e("p",null,[a("当 "),e("code",null,"-config"),a(" 没有指定时，Xray 将先后尝试从以下路径加载 "),e("code",null,"config.json"),a(" :")],-1),g=e("li",null,"工作目录（Working Directory）",-1),h=e("code",null,"Xray.location.asset",-1);function b(f,y){const s=n("I18nTip"),t=n("RouterLink");return l(),r("div",null,[i(s),v,e("div",m,[p,x,e("ul",null,[g,e("li",null,[i(t,{to:"/config/features/env.html#%E8%B5%84%E6%BA%90%E6%96%87%E4%BB%B6%E8%B7%AF%E5%BE%84"},{default:c(()=>[a("环境变量")]),_:1}),a("中 "),h,a(" 所指定的路径")])])])])}const w=d(u,[["render",b],["__file","command.html.vue"]]);export{w as default};
