...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="netfilter-配置" tabindex="-1"><a class="header-anchor" href="#netfilter-配置"><span>Netfilter 配置</span></a></h2><div class="custom-container warning"><p class="custom-container-title">注意</p><p>nftables 配置与 iptables 配置二选一，不可同时使用。</p></div>`,7),_=n("div",{class:"language-nftables line-numbers-mode","data-ext":"nftables","data-title":"nftables"},[n("pre",{class:"language-nftables"},[n("code",null,`#!/usr/sbin/nft -f
