import{_ as n,r as s,o as t,c as d,a as e,d as l,w as r,b as a,e as c}from"./app-B2-oELEu.js";const o={},u=c(`<h1 id="命令参数" tabindex="-1"><a class="header-anchor" href="#命令参数"><span>命令参数</span></a></h1><div class="custom-container tip"><p class="custom-container-title">提示</p><p>Xray 使用 Go 风格的命令及参数</p></div><h2 id="获取基本命令" tabindex="-1"><a class="header-anchor" href="#获取基本命令"><span>获取基本命令</span></a></h2><p>您可以运行 <code>xray help</code> 来获得所有 xray 最基础的用法, 以及可用的命令及说明。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>Xray is a platform for building proxies.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,40),v={class:"custom-container tip"},m=e("p",{class:"custom-container-title"},"提示",-1),x=e("p",null,[a("当 "),e("code",null,"-config"),a(" 没有指定时，Xray 将先后尝试从以下路径加载 "),e("code",null,"config.json"),a(" :")],-1),p=e("li",null,"工作目录（Working Directory）",-1),g=e("code",null,"Xray.location.asset",-1);function h(b,f){const i=s("RouterLink");return t(),d("div",null,[u,e("div",v,[m,x,e("ul",null,[p,e("li",null,[l(i,{to:"/config/features/env.html#%E8%B5%84%E6%BA%90%E6%96%87%E4%BB%B6%E8%B7%AF%E5%BE%84"},{default:r(()=>[a("环境变量")]),_:1}),a("中 "),g,a(" 所指定的路径")])])])])}const _=n(o,[["render",h],["__file","command.html.vue"]]);export{_ as default};
