...
虽然到上面一步已经可以结束了，但是如果你是个好奇心强盛的同学，一定会想起来，我在上一章说过，你把`xray-core` 的二进制文件“放在服务器运行，它就是服务器端；你把它下载到本地电脑运行，它就是客户端。” 那究竟要怎样直接使用 `xray-core` 做客户端呢？
...
那么你肯定会问，有了配置文件该怎么运行起来呢？双击好像并没有反应啊？
